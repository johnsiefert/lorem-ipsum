...
//when input of paragraphs
//we want to generate that number to paragraphs
//input is number of paragraphs
//the output needs to be that number in paragraphs
const form = document.querySelector('.lorem-form');
const result = document.querySelector('.lorem-text');
const amount = document.getElementById('amount');

function randomParagraph(e){
  e.preventDefault();
...
result.innerHTML = `<p class="result"> ${text[random]} </p>`;
  ...
  //reassign tempText to map method
...
form.addEventListener('submit', randomParagraph);
